...
//to go around the noise of the driver
int pwm_read_balance = 1;
//modes
...
void read_ultrasonic(int trigPin, int echoPin, int& distance) {  //(int&) means that this value will be changed for all the code (not internal value)
  ...
  distance = pwm_read_balance * travelTime * 0.034 / 2;  //calculate distance using time and the constant speed of sound
}
